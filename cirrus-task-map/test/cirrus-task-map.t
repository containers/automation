...
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
  ...
  "bindings" [shape=ellipse style=bold color=d fontcolor=d]
  "bindings" -> "success" [color=d]
  "bindings" -> "success" [color=d]
  "build" -> "bindings" [color=b]
  "build" -> "docker-py_test" [color=b]
  "docker-py_test" [shape=ellipse style=bold color=e fontcolor=e]
  "docker-py_test" -> "success" [color=e]
  "docker-py_test" -> "success" [color=e]
  "build" -> "docker-py_test" [color=b]
  "build" -> "endpoint" [color=b]
  "endpoint" [shape=ellipse style=bold color=f fontcolor=f]
  "endpoint" -> "success" [color=f]
  "endpoint" -> "success" [color=f]
  "build" -> "endpoint" [color=b]
  "build" -> "osx_cross" [color=b]
  "osx_cross" [shape=ellipse style=bold color=g fontcolor=g]
  "osx_cross" -> "success" [color=g]
  "osx_cross" -> "success" [color=g]
  "build" -> "osx_cross" [color=b]
  "build" -> "success" [color=b]
  "build" -> "success" [color=b]
  "build" -> "swagger" [color=b]
  "swagger" [shape=ellipse style=bold color=h fontcolor=h]
  "swagger" -> "success" [color=h]
  "swagger" -> "success" [color=h]
  "build" -> "swagger" [color=b]
  "build" -> "unit_test" [color=b]
  "unit_test" [shape=record style=bold color=i fontcolor=i label="unit_test\l|- Unit tests on fedora-32\l- Unit tests on fedora-31\l- Unit tests on ubuntu-20\l- Unit tests on ubuntu-19\l"]
  "unit_test" -> "success" [color=i]
  "unit_test" -> "success" [color=i]
  "build" -> "unit_test" [color=b]
  "build" -> "validate" [color=b]
  "validate" [shape=ellipse style=bold color=j fontcolor=j]
  "validate" -> "success" [color=j]
  "validate" -> "success" [color=j]
  "build" -> "validate" [color=b]
  "build" -> "vendor" [color=b]
  "vendor" [shape=ellipse style=bold color=k fontcolor=k]
  "vendor" -> "success" [color=k]
  "vendor" -> "success" [color=k]
  "build" -> "vendor" [color=b]
  "automation" -> "build" [color=a]
