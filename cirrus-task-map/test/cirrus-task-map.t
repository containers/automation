...
>>>>>>>>>>>>>>>>>>
  ...
  "just_one" [shape=ellipse style=bold color=a fontcolor=a]
...
>>>>>>>>>>>>>>>>>>
  ...
  "a" -> "b" [color=a]
  "b" [shape=ellipse style=bold color=b fontcolor=b]
...
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
  ...
  "end" [shape=ellipse style=bold color=b fontcolor=b]
  "real_name_of_initial" -> "middle_1" [color=a]
  "middle_1" [shape=ellipse style=bold color=c fontcolor=c]
  "middle_1" -> "end" [color=c]
  "real_name_of_initial" -> "middle_2" [color=a]
  "middle_2" [shape=ellipse style=bold color=d fontcolor=d]
  "middle_2" -> "end" [color=d]
...
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
  "a" [shape=record style=bold color=a fontcolor=a label="a\l|- name1\l- name2\l"]
...
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
  ...
  "alt_build" [shape=record style=bold color=c fontcolor=c label="alt_build\l|- Build Each Commit\l- Windows Cross\l- Build Without CGO\l- Build varlink API\l- Static build\l- Test build RPM\l"]
  "alt_build" -> "success" [color=c]
  "success" [shape=ellipse style=bold color=d fontcolor=d]
  "alt_build" -> "success" [color=c]
  "build" -> "alt_build" [color=b]
  "build" -> "bindings" [color=b]
  "bindings" [shape=ellipse style=bold color=e fontcolor=e]
  "bindings" -> "success" [color=e]
  "bindings" -> "success" [color=e]
  "build" -> "bindings" [color=b]
  "build" -> "docker-py_test" [color=b]
  "docker-py_test" [shape=ellipse style=bold color=f fontcolor=f]
  "docker-py_test" -> "success" [color=f]
  "docker-py_test" -> "success" [color=f]
  "build" -> "docker-py_test" [color=b]
  "build" -> "endpoint" [color=b]
  "endpoint" [shape=ellipse style=bold color=g fontcolor=g]
  "endpoint" -> "success" [color=g]
  "endpoint" -> "success" [color=g]
  "build" -> "endpoint" [color=b]
  "build" -> "osx_cross" [color=b]
  "osx_cross" [shape=ellipse style=bold color=h fontcolor=h]
  "osx_cross" -> "success" [color=h]
  "osx_cross" -> "success" [color=h]
  "build" -> "osx_cross" [color=b]
  "build" -> "success" [color=b]
  "build" -> "success" [color=b]
  "build" -> "swagger" [color=b]
  "swagger" [shape=ellipse style=bold color=i fontcolor=i]
  "swagger" -> "success" [color=i]
  "swagger" -> "success" [color=i]
  "build" -> "swagger" [color=b]
  ...
  "validate" [shape=ellipse style=bold color=k fontcolor=k]
  "validate" -> "success" [color=k]
  "validate" -> "success" [color=k]
  "build" -> "validate" [color=b]
  "build" -> "vendor" [color=b]
  "vendor" [shape=ellipse style=bold color=l fontcolor=l]
  "vendor" -> "success" [color=l]
  "vendor" -> "success" [color=l]
  "build" -> "vendor" [color=b]
  "automation" -> "build" [color=a]
  "automation" -> "success" [color=a]
  "automation" -> "success" [color=a]
  "ext_svc_check" [shape=ellipse style=bold color=m fontcolor=m]
  "ext_svc_check" -> "build" [color=m]
  "ext_svc_check" -> "build" [color=m]
  "ext_svc_check" -> "success" [color=m]
  "ext_svc_check" -> "success" [color=m]
  "smoke" [shape=ellipse style=bold color=n fontcolor=n]
  "smoke" -> "build" [color=n]
  "smoke" -> "build" [color=n]
  "smoke" -> "success" [color=n]
  "smoke" -> "success" [color=n]
