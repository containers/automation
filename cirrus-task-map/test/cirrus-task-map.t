...
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
  ...
  "alt_build" [shape=record style=bold color=j fontcolor=j label="alt build\l|- Build Each Commit\l- Windows Cross\l- Build Without CGO\l- Build varlink API\l- Static build\l- Test build RPM\l"]
  "alt_build" -> "success" [color=j]
  "build" -> "success" [color=b]
  "ext_svc_check" [shape=ellipse style=bold color=k fontcolor=k]
  "ext_svc_check" -> "success" [color=k]
  "ext_svc_check" -> "build" [color=k]
  "smoke" [shape=ellipse style=bold color=l fontcolor=l]
  "smoke" -> "success" [color=l]
  "smoke" -> "build" [color=l]
